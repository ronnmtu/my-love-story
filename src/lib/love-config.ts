  ...
  reasons: [
    {
      ...
      title: "Your Smile",
      message:
        "It rearranges my whole day. One look at it and whatever I was worried about quietly stops mattering. I'd cross any city just to see it in person.",
    },
    {
      icon: "🌷",
      title: "Your Kindness",
      message:
        "You are gentle with people in a way the world rarely is. You notice the small things, you remember, you show up. Loving you taught me how to be softer too.",
    },
    {
      icon: "✨",
      title: "Everything About You",
      message:
        "The laugh, the sleepy voice, the way you tell stories with your hands. Even the parts you think are too much — those are my favourite parts.",
    },
  ],
